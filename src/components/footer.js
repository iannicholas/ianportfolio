...
const link = {color: 'red', fontSize: '30px', margin: '20px'}
const nav = {backgroundColor: 'black', justifyContent: 'center'}
...
" target="blank" style={link}><BsLinkedin /></Nav.Link>
            ...
            <Nav.Link href="https://docs.google.com/document/d/1_doRDVq9zZmeb_vEt0z1FRzE0OCTECxpfiRpNM77CQI/edit?usp=sharing" style={link}><FaFileDownload /></Nav.Link>
          </Nav>
    </Navbar>
  );
}

export default IanFooter;